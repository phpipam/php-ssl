...
$select = "SELECT ca.id, ca.t_id, ca.name, ca.subject, ca.expires, ca.created,
...
<div class="page-header">
	<h2 class="page-title">
		<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon me-1"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 12l2 2l4 -4" /><path d="M11 3a8 8 0 1 0 0 16a8 8 0 0 0 0 -16" /><path d="M21 21l-1.5 -1.5" /></svg>
...
if (empty($groups)) {
    print "<tr><td colspan='5' class='text-muted'>" . _("No certificate authorities found.") . "</td></tr>";
} else {
    foreach ($groups as $tenant_id => $cas) {
        ...
        if (empty($cas)) {
            print "<tr><td colspan='5'><div class='alert alert-info py-2 mb-0'>" . _("No CAs for this tenant.") . "</div></td></tr>";
            continue;
        }
        ...
        foreach ($cas as $ca) {
            ...
            print "<tr>";
            print "  <td><b>" . htmlspecialchars($ca->name) . "</b></td>";
