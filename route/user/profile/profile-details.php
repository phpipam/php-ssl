<div class='card'>
	...
	<div>
	<table class='table table-borderless table-md table-hove1r table-td-top table-zones-details'>
		...
		<tr>
			...
			<td>
				<span class='badge' data-bs-toggle="tooltip" title="<?php print _("Days before expiry to warn"); ?>"><?php print (int)$view_user->days; ?> <?php print _("days"); ?></span>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<span class='badge' data-bs-toggle="tooltip" title="<?php print _("Days after expiry to still warn"); ?>"><?php print (int)$view_user->days_expired; ?> <?php print _("days"); ?></span>
			</td>
		</tr>
		...
		<tr class='line'>
			...
			<td>
				<div style='display:flex;flex-direction:column;gap:4px;align-items:flex-start;' class='actions'>
					<div>
						<a href='/route/modals/users/edit.php?action=edit&tenant=<?php print urlencode($user->href); ?>&id=<?php print (int)$view_user->id; ?>' class='btn btn-sm bg-info-lt' data-bs-toggle='modal' data-bs-target='#modal1'>
					...
					<div>
						<a href='/route/modals/users/edit.php?action=delete&tenant=<?php print urlencode($user->href); ?>&id=<?php print (int)$view_user->id; ?>&target=/logout/' class='btn btn-sm bg-info-lt text-danger' data-bs-toggle='modal' data-bs-target='#modal1'>
