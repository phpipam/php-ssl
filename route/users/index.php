...
<?php if($user->admin=="0") { ?>
<a href="/route/modals/users/edit.php?action=add&tenant=<?php print urlencode($user->href); ?>" data-bs-toggle="modal" data-bs-target="#modal1" class="btn btn-sm btn-outline-success btn-sm btn-5 d-none d-sm-inline-block <?php print $user->actions_disabled; ?>">
...
# reuse Result icons for passkey badges
$_pk_icon_success = $Result->get_icon('success');
$_pk_icon_info    = $Result->get_icon('info');
			...
			foreach ($group as $u) {
				...
				<div class="card text-center" style="padding:0px;padding-top:10px;">
                    ...
                    <a href="/route/modals/users/edit.php?action=edit&tenant='.$u_tenant_href.'&id='.$u_id.'" data-bs-toggle="modal" data-bs-target="#modal1" class="card-btn '.$user->actions_disabled.'" style="padding:0.6rem">
                      ...
                      Edit</a>
                    <a href="/route/modals/users/edit.php?action=delete&tenant='.$u_tenant_href.'&id='.$u_id.'" data-bs-toggle="modal" data-bs-target="#modal1" class="card-btn '.$user->actions_disabled.'" style="padding:0.6rem">
                    ...
                    <a href="/'.$user->href.'/user/impersonate/'.$u_id.'/" class="card-btn text-warning '.$disabled.'" style="padding:0.6rem">
