...
<a href='/route/modals/users/edit.php?action=edit&tenant=<?php print urlencode($_params['tenant']); ?>&id=<?php print (int)$view_user->id; ?>' class='btn btn-sm bg-info-lt <?php print $user->actions_disabled; ?>' data-bs-toggle='modal' data-bs-target='#modal1'>
	...
	<?php print _("Edit user"); ?>
</a>
<a href='/route/modals/users/edit.php?action=delete&tenant=<?php print urlencode($_params['tenant']); ?>&id=<?php print (int)$view_user->id; ?>' class='btn btn-sm bg-info-lt text-danger  <?php print $user->actions_disabled; ?>' data-bs-toggle='modal' data-bs-target='#modal1'>
