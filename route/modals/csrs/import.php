...
// Passphrase (revealed when encrypted key is detected)
...
(function () {
    ...
    $(document).off('click.csrImport').on('click.csrImport', '.modal-execute', function () {
        ...
        var keyPem     = document.getElementById('import-key-pem').value.trim();
        var certPem    = document.getElementById('import-cert-pem').value.trim();
        var passphrase = document.getElementById('import-key-passphrase').value;
        ...
        var payload = { csr_pem: csrPem, key_pem: keyPem };
