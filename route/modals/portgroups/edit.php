...
elseif ($_GET['action']!=="add" && is_null($port_group)) {
	...
	$content[] = "	<td>";
	$content[] = "		<input type='text' class='form-control form-control-sm' name='name' value='".@$port_group->name."' $disabled>";
	...
	$content[] = "	<td>";
	$content[] = "		<input type='text' class='form-control form-control-sm' name='ports' value='".@$port_group->ports."' $disabled placeholder='443,8443,9443'>";
